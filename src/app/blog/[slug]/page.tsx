      ...
      <article className="section" style={{ paddingTop: '6rem' }}>
        <div className="container" style={{ maxWidth: '800px' }}>
          <div className="animate-fade-in-up">
            <span style={{ color: 'var(--accent)', fontSize: '0.9rem', fontWeight: 'bold' }}>{post.category}</span>
            <h1 style={{ fontSize: '2.5rem', margin: '1rem 0 2rem 0', lineHeight: 1.2 }}>{post.title}</h1>
            ...
            <div className="glass-panel" style={{ padding: '2rem', lineHeight: 1.8, color: 'var(--text-muted)' }}>
              <p style={{ fontSize: '1.1rem', marginBottom: '1.5rem', color: 'var(--text-main)' }}>{post.summary}</p>
